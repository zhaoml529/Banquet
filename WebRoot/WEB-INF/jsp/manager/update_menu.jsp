...
<html>
  ...
  <body>
    <div class="container">
   	<form action="menuAction/updateMenu" method="post" role="form-control">
    ...
    <div class="media">
    			<img id="view" src="<%=basePath%>${!empty menu.zttp?menu.zttp:'imges/no_picture.gif' }" class="img-thumbnail" alt="${menu.tcmc }">
